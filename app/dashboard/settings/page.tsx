      ...
      <div className="border-b border-emerald-500/10 bg-[#0D0D0D] backdrop-blur-lg sticky top-0 z-40">
        <div className="px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-white font-bold">Gopal Hegde</h1>
              <p className="text-xs text-gray-500">GreenHarvest FPO Manager</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="p-2 hover:bg-white/5 rounded-lg transition-all relative"
            >
          ...
          <div className="p-8 w-full max-w-7xl mx-auto">
            <div className="space-y-8">
              ...
              <div className="text-center mb-12">
                <h1 className="text-4xl font-bold text-white mb-2">FPO Management</h1>
                <p className="text-gray-400">Manage your FPO code, share information, and view member statistics</p>
              </div>

              {/* FPO Management Section */}
              <FPODashboard />
            </div>
          </div>
        </main>
