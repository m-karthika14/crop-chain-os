          ...
          <div className="p-8 w-full max-w-5xl mx-auto">
            <div className="space-y-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">Complete record of all your sales transactions</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  <h3 className="text-sm font-semibold text-gray-400 mb-3">Total Sales</h3>
                  <p className="text-3xl font-bold text-white">680Q</p>
                  <p className="text-xs text-emerald-400 mt-2">All payments received</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="glass rounded-xl p-6 border border-emerald-500/10"
                >
                  <h3 className="text-sm font-semibold text-gray-400 mb-3">Average Price</h3>
                  <p className="text-3xl font-bold text-white">₹2,283</p>
                  <p className="text-xs text-emerald-400 mt-2">Per quintal</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="glass rounded-xl p-6 border border-emerald-500/10"
                >
                  <h3 className="text-sm font-semibold text-gray-400 mb-3">Pending Sales</h3>
                  <p className="text-3xl font-bold text-white">770Q</p>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-white/10">
                        ...
                        <th className="text-left py-3 px-4 text-gray-500 font-semibold">Price/Q</th>
                    ...
                    <tbody>
                      {[
                        { crop: 'Wheat', qty: '200Q', price: '₹2,400', total: '₹4,80,000', date: '2025-06-15', status: 'Paid' },
                        { crop: 'Rice', qty: '180Q', price: '₹2,150', total: '₹3,87,000', date: '2025-06-10', status: 'Paid' },
                        { crop: 'Maize', qty: '300Q', price: '₹2,200', total: '₹6,60,000', date: '2025-06-05', status: 'Paid' },
                      ].map((record, idx) => (
                        <tr key={idx} className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                          <td className="py-3 px-4 text-white">{record.crop}</td>
                          <td className="py-3 px-4 text-white">{record.qty}</td>
                          <td className="py-3 px-4 text-emerald-400 font-semibold">{record.price}</td>
                          <td className="py-3 px-4 text-white font-semibold">{record.total}</td>
